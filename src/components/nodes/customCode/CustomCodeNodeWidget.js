...
export class CustomCodeNodeWidget extends RJD.DefaultNodeWidget {
  static defaultProps = {
    node: null,
    color: 'rgb(73, 72, 79)'
  };
  ...
  getInPort() {
    ...
    if (displayOnly) {
      inputNode = new CustomCodeNodeModel(node.name, color);
    }
  ...
  getOutPort() {
    ...
    if (displayOnly) {
      outputNode = new CustomCodeNodeModel(node.name, color);
    }
    ...
    return (
      <div className='basic-node' style={style}>
        ...
        <div className="app-center">
          <span className="app-img-customCode">
          </span>
        </div>
        <div className='ports'>
          <div className='in'>
...
export const CustomCodeNodeWidgetFactory = React.createFactory(CustomCodeNodeWidget);
