...
export class PlayNDigitsNodeWidget extends RJD.DefaultNodeWidget {
  static defaultProps = {
    node: null,
    color: 'rgb(73, 72, 79)'
  };
  ...
  getInPort() {
    ...
    if (displayOnly) {
      inputNode = new PlayNDigitsNodeModel(node.name, color);
    }
  ...
  getOutPort() {
    ...
    if (displayOnly) {
      outputNode = new PlayNDigitsNodeModel(node.name, color);
    }
    ...
    return (
      <div className='basic-node' style={style}>
        ...
        <div className="app-center">
          <span className="app-img-playNdigits">
          </span>
        </div>
        <div className='ports'>
          <div className='in'>
...
export const PlayNDigitsNodeWidgetFactory = React.createFactory(PlayNDigitsNodeWidget);
