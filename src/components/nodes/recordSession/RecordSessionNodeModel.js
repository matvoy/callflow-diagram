...
export class RecordSessionNodeModel extends RJD.NodeModel {
  constructor(name = 'Untitled', color = 'rgb(114, 128, 150)', extras = { recordSession: { action:'start', type:'mp3', stereo:true, followTransfer:true, bridged:true, minSec:2, email:[] } }) {
    super('recordSession');
