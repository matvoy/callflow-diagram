...
export class SendEmailNodeWidget extends RJD.DefaultNodeWidget {
  static defaultProps = {
    node: null,
    color: 'rgb(73, 72, 79)'
  };
  ...
  getInPort() {
    ...
    if (displayOnly) {
      inputNode = new SendEmailNodeModel(node.name, color);
    }
  ...
  getOutPort() {
    ...
    if (displayOnly) {
      outputNode = new SendEmailNodeModel(node.name, color);
    }
    ...
    return (
      <div className='basic-node' style={style}>
        ...
        <div className="app-center">
          <span className="app-img-sendEmail">
          </span>
        </div>
        <div className='ports'>
          <div className='in'>
...
export const SendEmailNodeWidgetFactory = React.createFactory(SendEmailNodeWidget);
