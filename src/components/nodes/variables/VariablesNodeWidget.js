...
export class VariablesNodeWidget extends RJD.DefaultNodeWidget {
  static defaultProps = {
    node: null,
    color: 'rgb(73, 72, 79)'
  };
  ...
  getInPort() {
    ...
    if (displayOnly) {
      inputNode = new VariablesNodeModel(node.name, color);
    }
  ...
  getOutPort() {
    ...
    if (displayOnly) {
      outputNode = new VariablesNodeModel(node.name, color);
    }
    ...
    return (
      <div className='basic-node' style={style}>
        ...
        <div className="app-center">
          <span className="app-img-variables">
          </span>
        </div>
        <div className='ports'>
          <div className='in'>
...
export const VariablesNodeWidgetFactory = React.createFactory(VariablesNodeWidget);
