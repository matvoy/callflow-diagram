...
export class VoicemailNodeWidget extends RJD.DefaultNodeWidget {
  static defaultProps = {
    node: null,
    color: 'rgb(73, 72, 79)'
  };
  ...
  getInPort() {
    ...
    if (displayOnly) {
      inputNode = new VoicemailNodeModel(node.name, color);
    }
  ...
  getOutPort() {
    ...
    if (displayOnly) {
      outputNode = new VoicemailNodeModel(node.name, color);
    }
    ...
    return (
      <div className='basic-node' style={style}>
        ...
        <div className="app-center">
          <span className="app-img-voicemail">
          </span>
        </div>
        <div className='ports'>
          <div className='in'>
...
export const VoicemailNodeWidgetFactory = React.createFactory(VoicemailNodeWidget);
